...
if __name__ == '__main__':
    reader = TAQTradesReader('../data/trades/20070620/AAPL_trades.binRT')
    # print(reader.getN())
    # print(reader.getSecsFromEpocToMidn())
    # print(reader.getMillisFromMidn(0))
    # print(reader.getTimestamp(0))
    # print(reader.getPrice(0))
    # print(reader.getSize(0))
    print(type(reader._p))